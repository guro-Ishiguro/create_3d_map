...
class ViewerRecorder:
    def __init__(self, width=640, height=480, video_filename="output.avi", fps=10, record_video=False):
        """
        ビューワーと録画機能を初期化
    ...
    def record_frame(self):
        """ビューワーの現在のフレームを録画"""
        image = np.asarray(self.viewer.capture_screen_float_buffer(do_render=True)) * 255
